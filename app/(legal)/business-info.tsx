 ...
 *
 * 위치기반서비스사업 신고번호만 출처가 다르다(신고필증, 2026.09.08). 사업자등록증명에는 없는 항목이다.
 * 위치기반서비스 이용약관 제17조(사업자 정보)에도 같은 값이 적혀 있으니 한쪽만 고치지 않는다.
 */
...
const ROWS: [string, string][] = [
  ...
  ['위치기반서비스사업 신고번호', '제1529호 (2026.09.08, 방송미디어통신위원회)'],
  ...
  return (
    <SafeAreaView style={s.safe} edges={['top', 'bottom']}>
      ...
      <ScrollView style={s.scroll} contentContainerStyle={s.content} showsVerticalScrollIndicator={false}>
        ...
        <Text style={s.note}>
          상호·대표자·사업자등록번호·소재지·업태·종목은 사업자등록증명상의 내용과 동일합니다.
          문의는 위 이메일로 접수해 주세요.
        </Text>
      </ScrollView>
    </SafeAreaView>
