...
export const mockSpots: Spot[] = [
  {
    ...
    neighborhood: '망원',
    cover_image_url: 'https://loremflickr.com/400/300/park?lock=16',
  ...
  },
  {
    ...
    neighborhood: '망원',
    cover_image_url: 'https://loremflickr.com/400/300/park?lock=29',
  ...
  },
  {
    ...
    neighborhood: '홍대입구',
    cover_image_url: 'https://loremflickr.com/400/300/park?lock=11',
  ...
  },
  {
    ...
    neighborhood: '용산',
    cover_image_url: 'https://loremflickr.com/400/300/park?lock=20',
    status: 'active',
    created_source: 'seed',
  ...
  },
  {
    ...
    neighborhood: '이태원',
    cover_image_url: 'https://loremflickr.com/400/300/park?lock=65',
    status: 'active',
    created_source: 'seed',
  ...
  },
  {
    ...
    neighborhood: '성수',
    cover_image_url: 'https://loremflickr.com/400/300/park?lock=46',
    status: 'active',
    created_source: 'seed',
  ...
  },
  {
    ...
    neighborhood: '상암',
    cover_image_url: 'https://loremflickr.com/400/300/park?lock=68',
    status: 'active',
    created_source: 'seed',
  ...
  },
  {
    ...
    neighborhood: '합정',
    cover_image_url: 'https://loremflickr.com/400/300/park?lock=37',
    status: 'active',
    created_source: 'seed',
  ...
  },
  {
    ...
    neighborhood: '연남',
    cover_image_url: 'https://loremflickr.com/400/300/park?lock=7',
    status: 'active',
    created_source: 'seed',
  ...
  },
  {
    ...
    neighborhood: '반포',
    cover_image_url: 'https://loremflickr.com/400/300/park?lock=22',
    status: 'active',
    created_source: 'seed',
...
export const mockCheckins: PawCheckin[] = [
  ...
  // dog_001 (보리) — 사진 포함
  {
    ...
    photo_url: 'https://loremflickr.com/400/300/park?lock=43',
    visibility_level: 'spot_only', source_type: 'spot_detail',
